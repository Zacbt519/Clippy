    ...
    class Program
    {
        ...
        static async Task RunAsync(IConfiguration configuration)
        {
            ...
            client.Ready += async () =>
            {
                if (IsDebug())
                    ...
                    await commands.RegisterCommandsToGuildAsync(642132114086690828);
                else
            ...
            await client.LoginAsync(TokenType.Bot, File.ReadAllText("src/Resources/DiscordToken.txt"));
        ...
        static ServiceProvider ConfigureServices(IConfiguration configuration)
        {
            return new ServiceCollection()
                ...
                .AddSingleton<CatAPIService>()
                .AddSingleton<EmbedService>()
                .AddSingleton<LoggingService>()
                .AddSingleton<LoggingMessagingService>()
                .AddSingleton<NBGovService>()
                .AddSingleton<XKCDService>()
                .AddSingleton<XKCDEmbedService>()
                .AddSingleton<WeatherService>()
                .AddSingleton<WeatherEmbedService>()
                .AddSingleton<SwansonAPIService>()
                .AddSingleton<SwansonEmbedService>()
                .AddSingleton<UpcomingService>()
                .AddSingleton<UpcomingEmbedService>()
                .AddSingleton<CBCRSSService>()
                .AddSingleton<CBCEmbedService>()
